...
let TEXT_WINGIT = "Wingit"
let TEXT_INTRO_TAGLINE = "Experience the power of community."
...
let APP_STORE_LINK = "https://apps.apple.com/us/app/winging/id1572569005"
let LOGO_URL = """
                  ...
                  """
let TEXT_SHARE_WINGIT = "Hey, I think you would be interested in this new app called Wingit! You can download it here: \(APP_STORE_LINK)"
...
class Ref {
    ...
    static func FS_COLLECTION_REFERRALS_RECEIVED_BY(userId: String) -> CollectionReference? {
        return FS_COLLECTION_REFERRALS.whereField("recipientId", isEqualTo: userId) as? CollectionReference
    }
